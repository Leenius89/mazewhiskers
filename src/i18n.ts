...
const ko: Dict = {
    ...
    'menu.endings': '도감',
    'menu.rankingShort': '랭킹',
    'menu.daily': '오늘의 도시',
    'daily.tag': '오늘의 도시',
    'daily.best': '오늘 최고',
    'daily.tries': '{n}번째',
    'daily.streak': '{n}일째',
    'daily.newBest': '오늘의 도시 내 최고 점수입니다',
    'endings.title': '엔딩 도감',
    'endings.home.body': '도시가 먼저 도착하지 못했습니다. 이번에는.',
    'endings.note': '아직 보지 못한 끝이 남아 있습니다.',
    'endings.complete': '이 도시가 고양이를 내보내는 방법을 모두 보았습니다. 그리고 한 번은 집에 닿았습니다.',
    ...
    'settings.comfort': '진동 · 화면 효과 / COMFORT',
    'settings.haptics': '진동',
    'settings.reducedEffects': '효과 줄이기',
    'settings.dark': '어둡게',
    'settings.light': '밝게',
    ...
    'over.lasted': '⏱ 버틴 시간',
    'slip.total': 'RANK SCORE',
    'slip.gathered': '모은 것',
    'slip.clear': '도착',
    'slip.time': '시간',
    'slip.weight': '난이도',
    'slip.sending': '랭킹에 올리는 중…',
    'slip.sent': '토스 랭킹에 올렸습니다',
    'slip.rejected': '랭킹에 올리지 못했습니다. 기록은 이 기기에 남아 있습니다.',
    'slip.kept': '기록을 이 기기에 저장했습니다',
    'slip.newScore': '내 최고 점수를 넘었습니다',
    'slip.newClear': '내 가장 빠른 도착입니다',
    'records.title': '내 기록',
    'records.empty': '아직 기록이 없습니다. 한 판 달리고 오면 여기에 남습니다.',
    'records.bestScore': 'BEST SCORE',
    'records.bestClear': '⚑ 최단 도착',
    'records.longest': '⏱ 최장 생존',
    'records.runs': '달린 횟수',
    'records.clears': '도착 횟수',
    'records.tossNote': '다른 고양이들과의 순위는 토스 앱의 랭킹에서 볼 수 있습니다.',
    'leave.title': '게임을 끝낼까요?',
    'leave.body': '기록은 저장되어 있습니다. 언제든 돌아와서 이어 달릴 수 있습니다.',
    'leave.stay': '계속하기',
    'leave.go': '나가기',
    'over.retry': '다시 / RETRY',
    'over.mainMenu': '메뉴로',
    ...
    'cat.idle.2': '캬캬캬',
    'cat.idle.3': '또 왔네?',
    'cat.idle.4': '이 동네 내 구역인데',
    'cat.idle.5': '오늘은 조용하네',
    'cat.idle.6': '배고프다...',
    'cat.meet.a.1': '어이, 또 너야?',
    'cat.meet.a.2': '여기 내 자리거든?',
    'cat.meet.a.3': '캬캬캬, 곧 아닐걸',
    'cat.meet.b.1': '저 위에 아파트 또 생긴대',
    'cat.meet.b.2': '나쁠 거 있나. 난 지붕이 좋아',
    'cat.meet.c.1': '집에 가는 길 알아?',
    'cat.meet.c.2': '알지. 안 알려줄 뿐이야',
    'cat.meet.c.3': '치사해',
    'cat.chase.tabby.1': '으악!',
    'cat.chase.tabby.2': '아 왜 또!',
    'cat.chase.tabby.3': '살려!',
    'cat.chase.black.1': '캬캬캬캬',
    'cat.chase.black.2': '거기 서!',
    'cat.chase.black.3': '어디 가~',
    'cat.escaped.1': '하아... 하아...',
    'cat.escaped.2': '심장 떨어질 뻔',
    'cat.taunt.1': '겨우 그거야? 캬캬캬',
    'cat.taunt.2': '집이 저기 있는데 말이지~',
    'cat.taunt.3': '야옹~ 다음엔 좀 더 빨리 뛰어',
    'cat.taunt.4': '내 자리 앉아도 되지?',
    'cat.taunt.5': '한 번 더 해봐. 기다려 줄게',
    'tut.nightmare': '설명 같은 건 없어. 할 수 있으면 해보든가~ 캬캬캬',
    'tut.nightmare.speaker': '· 어둠 속에서',
...
const en: Dict = {
    ...
    'daily.tries': 'try {n}',
    'daily.streak': 'day {n}',
    'daily.newBest': "Your best on today's city",
    'endings.title': 'Endings',
    'endings.home.body': 'The city did not get there first. This time.',
    'endings.note': 'There are endings you have not seen.',
    'endings.complete': 'You have seen every way this city shows a cat out. And once, you got home.',
    ...
    'settings.reducedEffects': 'LESS FLASH',
    'settings.dark': 'DARK',
    ...
    'over.lasted': '⏱ LASTED',
    'slip.total': 'RANK SCORE',
    'slip.gathered': 'Gathered',
    'slip.clear': 'Home',
    'slip.time': 'Time',
    'slip.weight': 'Difficulty',
    'slip.sending': 'Sending to the board…',
    'slip.sent': 'On the Toss leaderboard',
    'slip.rejected': 'Could not reach the board. The run is saved on this device.',
    'slip.kept': 'Saved on this device',
    'slip.newScore': 'Your best score yet',
    'slip.newClear': 'Your fastest way home',
    'records.title': 'My Records',
    'records.empty': 'Nothing yet. Go for a run and it will be here.',
    'records.bestScore': 'BEST SCORE',
    'records.bestClear': '⚑ FASTEST HOME',
    'records.longest': '⏱ LONGEST RUN',
    'records.runs': 'RUNS',
    'records.clears': 'TIMES HOME',
    'records.tossNote': 'Rankings against other cats are on the leaderboard in the Toss app.',
    'leave.title': 'Leave the game?',
    'leave.body': 'Your records are saved. Come back and run again whenever you like.',
    ...
    'cat.idle.4': 'my street, this',
    'cat.idle.5': 'quiet tonight',
    'cat.idle.6': "I'm starving...",
    'cat.meet.a.1': 'oi, you again?',
    'cat.meet.a.2': 'this is my spot, actually',
    'cat.meet.a.3': "hehehe, not for long",
    'cat.meet.b.1': "they're putting up another tower",
    'cat.meet.b.2': 'suits me. I like the roofs',
    'cat.meet.c.1': 'you know the way home?',
    'cat.meet.c.2': "I do. I'm just not telling",
    'cat.meet.c.3': 'charming',
    'cat.chase.tabby.1': 'aaah!',
    'cat.chase.tabby.2': 'oh come ON',
    'cat.chase.tabby.3': 'help!',
    'cat.chase.black.1': 'hehehehe',
    'cat.chase.black.2': 'come back!',
    'cat.chase.black.3': 'going somewhere~',
    'cat.escaped.1': 'hah... hah...',
    'cat.escaped.2': 'nearly had me',
    'cat.taunt.1': 'that was it? hehehe',
    'cat.taunt.2': 'home was right there~',
    'cat.taunt.3': 'meow~ run faster next time',
    'cat.taunt.4': "mind if I sit here?",
    'cat.taunt.5': "go on, again. I'll wait",
    'tut.nightmare': "No lesson this time. Have a go, if you think you can~ hehehe",
    'tut.nightmare.speaker': '· from the dark',
