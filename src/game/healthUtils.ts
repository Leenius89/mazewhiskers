...
export const setupHealthSystem = (scene: CustomScene, player: Phaser.Physics.Arcade.Sprite, fishes: Phaser.Physics.Arcade.Group) => {
    ...
    scene.physics.add.overlap(player, fishes, (p, f) => {
