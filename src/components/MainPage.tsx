...
const MainPage: React.FC<MainPageProps> = ({ onStartGame, gameSize }) => {
    ...
    const [_cameraPosition, setCameraPosition] = useState(0); // Using _ prefix as it's not currently used for logic but set in timeout
    ...
    const startExperience = async () => {
        try {
            audioRef.current = new Audio('sources/main.mp3'); // Fix path if necessary, relative to public
            ...
            <div style={{
                ...
                <motion.div
                    style={{
                        ...
                        marginRight: 'auto',
                        zIndex: 2,
                        width: typeof gameSize.width === 'number' ? `${gameSize.width}px` : gameSize.width, // Fix for width handling
                        display: 'flex',
                        justifyContent: 'center',
                        alignItems: 'center'
                    }}
